...
rb_fde_t __must_check *rb_socket(int family, int sock_type, int proto, const char *note);
int __must_check rb_socketpair(int family, int sock_type, int proto, rb_fde_t **F1, rb_fde_t **F2,
                  const char *note);
...
ssize_t __must_check rb_read(rb_fde_t *, void *buf, int count);
int __must_check rb_pipe(rb_fde_t **, rb_fde_t **, const char *desc);

int __must_check rb_setup_ssl_server(const char *cert, const char *keyfile, const char *dhfile);
int __must_check rb_ssl_listen(rb_fde_t *, int backlog, int defer_accept);
int __must_check rb_listen(rb_fde_t *, int backlog, int defer_accept);
